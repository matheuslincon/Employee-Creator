...
public class EmployeeController {
    ...
    @Operation(summary = "Finds employees by name", description = "Finds employees by name", tags = {"Employees"}, responses = {
            @ApiResponse(description = "Success", responseCode = "200", content = {
                    @Content(mediaType = "application/json",
                            array = @ArraySchema(schema = @Schema(implementation = EmployeeDTO.class))
                    )
    ...
    public ResponseEntity<PagedModel<EntityModel<EmployeeDTO>>> findEmployeesByName(
        ...
        return new ResponseEntity<>(this.service.findEmployeesByName(firstName, pageable), HttpStatus.OK);
    }
